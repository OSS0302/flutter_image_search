...
mixin _$PixabayState {
  List<PixabayItem> get pixabyaItem => throw _privateConstructorUsedError;
...
abstract class $PixabayStateCopyWith<$Res> {
  ...
  @useResult
  $Res call({List<PixabayItem> pixabyaItem, bool isLoading});
}
...
class _$PixabayStateCopyWithImpl<$Res, $Val extends PixabayState>
  ...
  @override
  $Res call({
    Object? pixabyaItem = null,
    Object? isLoading = null,
  }) {
    return _then(_value.copyWith(
      pixabyaItem: null == pixabyaItem
          ? _value.pixabyaItem
          : pixabyaItem // ignore: cast_nullable_to_non_nullable
              as List<PixabayItem>,
...
class _$PixabayStateImpl with DiagnosticableTreeMixin implements _PixabayState {
  const _$PixabayStateImpl(
      {final List<PixabayItem> pixabyaItem = const [], this.isLoading = false})
      : _pixabyaItem = pixabyaItem;

  factory _$PixabayStateImpl.fromJson(Map<String, dynamic> json) =>
      _$$PixabayStateImplFromJson(json);

  final List<PixabayItem> _pixabyaItem;
  @override
  @JsonKey()
  List<PixabayItem> get pixabyaItem {
    if (_pixabyaItem is EqualUnmodifiableListView) return _pixabyaItem;
    // ignore: implicit_dynamic_type
    return EqualUnmodifiableListView(_pixabyaItem);
  }
  ...
  String toString({DiagnosticLevel minLevel = DiagnosticLevel.info}) {
    return 'PixabayState(pixabyaItem: $pixabyaItem, isLoading: $isLoading)';
  }
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    properties
      ...
      ..add(DiagnosticsProperty('pixabyaItem', pixabyaItem))
    ...
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            const DeepCollectionEquality()
                .equals(other._pixabyaItem, _pixabyaItem) &&
  ...
  int get hashCode => Object.hash(runtimeType,
      const DeepCollectionEquality().hash(_pixabyaItem), isLoading);
...
abstract class _PixabayState implements PixabayState {
  const factory _PixabayState(
      {final List<PixabayItem> pixabyaItem,
